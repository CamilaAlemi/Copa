...
{
    codigo: "BEL - TEC",
    imagem: "../../imgs/belgica/selecao/rudigarcia.webp",
    posicao: "TREINADOR",
    nome: "Rudi Garcia",
    cidade: "Nemours, França",
    copas: "1ª",
    idade: "62",
    destaque: "Comando",
    cores: ["#000000", "#FFD90C", "#EF3340"]
},
{
    codigo: "BEL - 001",
    imagem: "../../imgs/belgica/selecao/courtois.jpg",
    posicao: "GOLEIRO",
    nome: "Courtois",
    cidade: "Bree, Bélgica",
    copas: "4ª",
...
{
    codigo: "BEL - 002",
    imagem: "../../imgs/belgica/selecao/lammens.jpg",
    posicao: "GOLEIRO",
    nome: "Lammens",
...
{
    codigo: "BEL - 003",
    imagem: "../../imgs/belgica/selecao/mikependers.jpg",
    posicao: "GOLEIRO",
    nome: "Mike Penders",
    cidade: "Genk, Bélgica",
    copas: "1ª",
...
{
    codigo: "BEL - 004",
    imagem: "../../imgs/belgica/selecao/castagne.jpg",
    posicao: "LATERAL",
    nome: "Timothy Castagne",
    cidade: "Arlon, Bélgica",
    copas: "2ª",
    idade: "30",
    destaque: "Regularidade",
    cores: ["#000000", "#FFD90C", "#EF3340"]
},

{
    codigo: "BEL - 005",
    imagem: "../../imgs/belgica/selecao/debast.jpg",
    posicao: "ZAGUEIRO",
    nome: "Zeno Debast",
    cidade: "Halle, Bélgica",
    copas: "1ª",
    idade: "22",
    destaque: "Saída de bola",
    cores: ["#000000", "#FFD90C", "#EF3340"]
},

{
    codigo: "BEL - 006",
    imagem: "../../imgs/belgica/selecao/dewinter.jpg",
    posicao: "ZAGUEIRO",
    nome: "Koni De Winter",
    cidade: "Antuérpia, Bélgica",
    copas: "1ª",
...
{
    codigo: "BEL - 007",
    imagem: "../../imgs/belgica/selecao/mechele.jpg",
    posicao: "ZAGUEIRO",
    nome: "Brandon Mechele",
...
{
    codigo: "BEL - 008",
    imagem: "../../imgs/belgica/selecao/theate.jpg",
    posicao: "ZAGUEIRO",
    nome: "Arthur Theate",
    cidade: "Liège, Bélgica",
    copas: "2ª",
    idade: "25",
    destaque: "Força",
    cores: ["#000000", "#FFD90C", "#EF3340"]
...
{
    codigo: "BEL - 009",
    imagem: "../../imgs/belgica/selecao/decuyper.jpg",
    posicao: "LATERAL",
    nome: "Maxim De Cuyper",
    cidade: "Knokke-Heist, Bélgica",
    copas: "1ª",
    idade: "25",
    destaque: "Apoio",
    cores: ["#000000", "#FFD90C", "#EF3340"]
...
{
    codigo: "BEL - 010",
    imagem: "../../imgs/belgica/selecao/meunier.png",
    posicao: "LATERAL",
    nome: "Thomas Meunier",
    cidade: "Sainte-Ode, Bélgica",
    copas: "3ª",
    idade: "34",
    destaque: "Experiência",
    cores: ["#000000", "#FFD90C", "#EF3340"]
...
{
    codigo: "BEL - 011",
    imagem: "../../imgs/belgica/selecao/ngoy.jpg",
    posicao: "ZAGUEIRO",
    nome: "Nathan Ngoy",
...
{
    codigo: "BEL - 012",
    imagem: "../../imgs/belgica/selecao/seys.jpg",
    posicao: "LATERAL",
    nome: "Joaquin Seys",
    cidade: "Bruges, Bélgica",
    copas: "1ª",
...
{
    codigo: "BEL - 013",
    imagem: "../../imgs/belgica/selecao/debruyne.jpg",
    posicao: "MEIA",
    nome: "Kevin De Bruyne",
    cidade: "Drongen, Bélgica",
    copas: "4ª",
    idade: "35",
    destaque: "Craque",
    cores: ["#000000", "#FFD90C", "#EF3340"]
...
{
    codigo: "BEL - 014",
    imagem: "../../imgs/belgica/selecao/onana.png",
    posicao: "VOLANTE",
    nome: "Amadou Onana",
    cidade: "Dakar, Senegal",
    copas: "2ª",
    idade: "24",
    destaque: "Força física",
    cores: ["#000000", "#FFD90C", "#EF3340"]
},

{
    codigo: "BEL - 015",
    imagem: "../../imgs/belgica/selecao/raskin.jpg",
    posicao: "VOLANTE",
    nome: "Nicolas Raskin",
    cidade: "Liège, Bélgica",
    copas: "1ª",
...
{
    codigo: "BEL - 016",
    imagem: "../../imgs/belgica/selecao/tielemans.jpg",
    posicao: "MEIA",
    nome: "Youri Tielemans",
    cidade: "Sint-Pieters-Leeuw, Bélgica",
    copas: "3ª",
    idade: "28",
    destaque: "Controle",
    cores: ["#000000", "#FFD90C", "#EF3340"]
...
{
    codigo: "BEL - 017",
    imagem: "../../imgs/belgica/selecao/vanaken.jpg",
    posicao: "MEIA",
    nome: "Hans Vanaken",
    cidade: "Neerpelt, Bélgica",
    copas: "2ª",
    idade: "33",
    destaque: "Visão de jogo",
    cores: ["#000000", "#FFD90C", "#EF3340"]
},

{
    codigo: "BEL - 018",
    imagem: "../../imgs/belgica/selecao/witsel.jpg",
    posicao: "VOLANTE",
    nome: "Axel Witsel",
    cidade: "Liège, Bélgica",
    copas: "4ª",
...
{
    codigo: "BEL - 019",
    imagem: "../../imgs/belgica/selecao/dekete.jpg",
    posicao: "ATACANTE",
...
{
    codigo: "BEL - 020",
    imagem: "../../imgs/belgica/selecao/fernandezPardo.jpg",
    posicao: "ATACANTE",
...
{
    codigo: "BEL - 021",
    imagem: "../../imgs/belgica/selecao/doku.jpg",
    posicao: "ATACANTE",
    nome: "Jeremy Doku",
    cidade: "Antuérpia, Bélgica",
    copas: "2ª",
...
{
    codigo: "BEL - 022",
    imagem: "../../imgs/belgica/selecao/lukaku.jpg",
    posicao: "ATACANTE",
    nome: "Romelu Lukaku",
    cidade: "Antuérpia, Bélgica",
    copas: "4ª",
...
{
    codigo: "BEL - 023",
    imagem: "../../imgs/belgica/selecao/sael.jpg",
    posicao: "ATACANTE",
    nome: "Alexis Saelemaekers",
    cidade: "Berchem, Bélgica",
    copas: "2ª",
    idade: "27",
...
{
    codigo: "BEL - 024",
    imagem: "../../imgs/belgica/selecao/trossard.jpg",
    posicao: "ATACANTE",
    nome: "Leandro Trossard",
    cidade: "Maasmechelen, Bélgica",
    copas: "2ª",
    idade: "31",
    destaque: "Finalização",
    cores: ["#000000", "#FFD90C", "#EF3340"]
},

{
    codigo: "BEL - 025",
    imagem: "../../imgs/belgica/selecao/luke.jpg",
    posicao: "ATACANTE",
    nome: "Dodi Lukebakio",
    cidade: "Asse, Bélgica",
    copas: "1ª",
...
{
    codigo: "BEL - 026",
    imagem: "../../imgs/belgica/selecao/diego.jpg",
    posicao: "ATACANTE",
    nome: "Diego Moreira",
    cidade: "Liège, Bélgica",
    copas: "1ª",
...
{
    codigo: "BRA - 003",
 imagem: "../../imgs/Brasil/selecao/bremer_SB.webp",
    posicao: "ZAGUEIRO",
    nome: "Bremer",
...
{
    codigo: "BRA - 014",
 imagem: "../../imgs/Brasil/selecao/gabrielMagalhaes_SB.webp",
    posicao: "ZAGUEIRO",
...
{
    codigo: "BRA - 002",
 imagem: "../../imgs/Brasil/selecao/danilo_SB.jpg",
    posicao: "LATERAL",
    nome: "Danilo",
    cidade: "Bicas, Brasil",
    copas: "3ª",
...
{
    codigo: "BRA - 004",
    imagem: "../../imgs/Brasil/selecao/marquinhos.webp",
    posicao: "ZAGUEIRO",
    nome: "Marquinhos",
    cidade: "São Paulo, Brasil",
    copas: "3ª",
...
{
    codigo: "BRA - 013",
    imagem: "../../imgs/Brasil/selecao/ibanez_SB.webp",
    posicao: "ZAGUEIRO",
    nome: "Ibañez",
...
{
    codigo: "BRA - 015",
    imagem: "../../imgs/Brasil/selecao/leoPereira_SB.webp",
    posicao: "ZAGUEIRO",
    nome: "Léo Pereira",
...
{
    codigo: "BRA - 016",
    imagem: "../../imgs/Brasil/selecao/douglasantos.webp",
    posicao: "LATERAL",
    nome: "Douglas Santos",
...
{
    codigo: "BRA - 024",
    imagem: "../../imgs/Brasil/selecao/wesley_SB.jpg",
    posicao: "LATERAL",
    nome: "Wesley",
...
{
    codigo: "BRA - 025",
    imagem: "../../imgs/Brasil/selecao/daniloSantosBotafogo_SB.jpg",
    posicao: "VOLANTE",
    nome: "Danilo Santos",
...
{
    codigo: "BRA - 026",
    imagem: "../../imgs/Brasil/selecao/fabinho_SB.jpg",
    posicao: "VOLANTE",
    nome: "Fabinho",
...
{
    codigo: "BRA - 006",
 imagem: "../../imgs/Brasil/selecao/alex_SB.jpg",
    posicao: "LATERAL",
    nome: "Alex Sandro",
...
{
    codigo: "BRA - 027",
    imagem: "../../imgs/Brasil/selecao/igorthiago_SB.webp",
    posicao: "ATACANTE",
    nome: "Igor Thiago",
    cidade: "Gama, Brasil",
    copas: "1ª",
...
{
    codigo: "BRA - 007",
    imagem: "../../imgs/Brasil/selecao/raphinha_SB.webp",
    posicao: "PONTA",
    nome: "Raphinha",
...
{
    codigo: "BRA - 010",
    imagem: "../../imgs/Brasil/selecao/viniJr_SB.webp",
    posicao: "ATACANTE",
    nome: "Vini Jr.",
...
{
    codigo: "BRA - 005",
 imagem: "../../imgs/Brasil/selecao/casemiro.webp",
    posicao: "VOLANTE",
    nome: "Casemiro",
...
{
    codigo: "BRA - 008",
 imagem: "../../imgs/Brasil/selecao/brunoGuimaraes_SB.jpg",
    posicao: "MEIA",
...
{
    codigo: "BRA - 017",
 imagem: "../../imgs/Brasil/selecao/lucasPaqueta_SB.webp",
    posicao: "MEIA",
    nome: "Lucas Paquetá",
    cidade: "Rio de Janeiro, Brasil",
    copas: "3ª",
...
{
    codigo: "BRA - 011",
 imagem: "../../imgs/Brasil/selecao/neymar_SB.jpg",
    posicao: "ATACANTE",
    nome: "Neymar",
...
{
    codigo: "BRA - 021",
 imagem: "../../imgs/Brasil/selecao/endrick_SB.jpg",
    posicao: "ATACANTE",
    nome: "Endrick",
...
{
    codigo: "BRA - 022",
 imagem: "../../imgs/Brasil/selecao/gabrielMartinelli_SB.jpg",
    posicao: "ATACANTE",
...
{
    codigo: "BRA - 018",
    imagem: "../../imgs/Brasil/selecao/mateuscunha.jpg",
    posicao: "ATACANTE",
    nome: "Matheus Cunha",
    cidade: "João Pessoa, Brasil",
    copas: "2ª",
...
{
    codigo: "BRA - 019",
 imagem: "../../imgs/Brasil/selecao/luisHenrique_SB.jpg",
    posicao: "ATACANTE",
    nome: "Luiz Henrique",
...
{
    codigo: "BRA - 020",
 imagem: "../../imgs/Brasil/selecao/rayan_SB.jpg",
    posicao: "ATACANTE",
    nome: "Rayan",
    cidade: "Rio de Janeiro, Brasil",
    copas: "1ª",
...
function atualizarCoresPais(pais){
    ...
    const coresPais = selecoes[pais][0].cores
...
function renderizarJogadores(pais){
console.log("País recebido:", pais);
    console.log("Dados:", selecoes[pais]);
    ...
    atualizarCoresPais(pais)

    selecoes[pais].forEach(jogador => {
        ...
        <div class="card">
            ...
            <div class="infos">
                ...
                <div class="info">
                    <p class="numero">${jogador.copas}</p>
                    <p class="texto">Copa</p>
                </div>

                <div class="info">
                    <p class="numero">${jogador.idade}</p>
                    <p class="texto">Anos</p>
                </div>

                <div class="info">
                    <p class="numero estrela">★</p>
                    <p class="texto">${jogador.destaque}</p>
                </div>
...
function scrollJogadores(direcao){
